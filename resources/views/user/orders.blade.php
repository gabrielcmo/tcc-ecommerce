                    ...
                    <div id="pedido{{$loop->iteration}}-accordion-collapse" class="collapse" aria-labelledby="pedido{{$loop->iteration}}-accordion-header" data-parent="#pedido{{$loop->iteration}}-accordion">
                      <div class="card-body">
                        <div>
                          ...
                          <button class="mdc-button mdc-button--raised general-button showProducts" data-pedido-id="{{$pedido->id}}" data-href="{{route('showOrderProducts')}}">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="orderProductsModal-title">Produtos da compra de número: {{$order_product->id}}</h5>
